...
<qgis readOnly="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" minScale="1e+08" version="3.4.3-Madeira" maxScale="0">
  ...
  <aliases>
    ...
    <alias name="" field="permanent" index="2"/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="permanent" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint notnull_strength="0" field="permanent" constraints="0" unique_strength="0" exp_strength="0"/>
  </constraints>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="-1" type="field" name="permanent" hidden="0"/>
