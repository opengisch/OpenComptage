...
class Comptages:
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/Comptages/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Comptages'),
            callback=self.run,
