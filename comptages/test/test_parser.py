...
class TestDataParser(unittest.TestCase):
    def test_parse_data_line(self):
        ...
        self.assertEqual(data['distance_front_rear'], 27.7)
    ...
    def test_parse_data_line_with_allowed_missing_int_values(self):
        ...
        self.assertEqual(data['distance_front_rear'], 33.4)
    ...
    def test_parse_setting_line_vith_value(self):
        dp = DataParserVdv1()
        parsed_line = dp.parse_line('* FORMATTER = GRFORMAT Release = 3.5.47')
        line_type = parsed_line[0]
        data = parsed_line[1]
